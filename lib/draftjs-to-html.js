...
function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
  ...
  if (entity.type === 'IMAGE') {
    ...
    return '<div style="text-align:' + alignment + ';"><img src="' + entity.data.src + '" alt="' + entity.data.alt + '" style="text-align:' + alignment + '; height: ' + entity.data.height + ';width: ' + entity.data.width + '"/></div>';
  }
